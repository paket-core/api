...
- As the launcher, create the escrow account. Unlike the accounts in the setup
  ...
  launcher, and it will be the launhcer's responsibility to merge this account
    ...
    'parameters': [
        {
            ...
            'in': 'formData', 'required': False, 'type': 'integer'},
        {
            'name': 'allow_mock', 'description': 'allow mock data in case of empty db',
            'in': 'formData', 'required': False, 'type': 'boolean'}
    ],
    'responses': {
